...
import 'package:dnl_ui/core/utils/convTime.dart';
import 'package:dnl_ui/core/values/custom_text_style.dart';
import 'package:dnl_ui/core/widgets/image_placeholder_button.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Text("First image will be your profile photo.",
            textAlign: TextAlign.center,
            style: CustomTextStyle.getDescStyle(
                Theme.of(context).colorScheme.onSurface)),
      ],
